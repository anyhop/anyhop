...
# — never `rumps`, an `anyhop-tray` launcher, `anyhop.tray`, or `anyhop.companion`.
...
class Anyhop < Formula
  ...
  url "https://files.pythonhosted.org/packages/96/fe/63196332a103c722b4a4260b94edc44ff43cdf20e1bd74055ca610e20498/anyhop-0.1.8.tar.gz"
