"""Shared constants for the single sing-box process anyhop runs."""

from __future__ import annotations

# Pinned sing-box release. anyhop always uses exactly this build, downloaded
# from upstream into ~/.anyhop/bin/sing-box@<version> and verified against the
...
# per-packet cost is the price of never crashing. ``ANYHOP_WG_MTU`` overrides it
